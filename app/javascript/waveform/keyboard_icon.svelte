<script>
    ...
    import { fmap_helper } from '../work/keyboard_helper'
    import { x as map } from '../waveform/keys_waveform'
    export let waveform;
    let keyboard;
    onMount( () => {
        keyboard.focus();
    ...
    function keydown(e){
        e.preventDefault();
        const userf = fmap_helper(true, waveform, e, map);
        if(userf){
...
<div bind:this={keyboard} on:keydown={keydown} class="keyboard text-center mx-auto" style="width: 30px" tabindex="0">
